...
const Chatbot = {
    ...
    knowledgeBase: {
        ...
        'stats_export': {
            ...
            a: 'В верхнем правом углу (иконка шестеренки) есть кнопка "Экспорт". Она скачает все данные вашего ребенка в виде JSON-файла. Вы можете загрузить их обратно кнопкой "Импорт".'
        },
        'teeth_module': {
        ...
        'multiple_children': {
            ...
            a: 'Да! В настройках можно создать несколько профилей и быстро переключаться между ними. Данные каждого ребенка хранятся отдельно.'
        }
    },
